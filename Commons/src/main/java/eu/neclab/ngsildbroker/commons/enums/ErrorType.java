...
public enum ErrorType {
	...
	SubscriptionContextMissing(500, "urn:norda:scorpio:error:subscription-context-missing",
			"Subscription context is missing."),
	SubscriptionNotLoaded(500, "urn:norda:scorpio:error:subscription-not-loaded",
			"Subscription is not loaded."),
	SubscriptionPersistenceInvariant(500, "urn:norda:scorpio:error:subscription-persistence-invariant",
			"Subscription persistence invariant failed."),
